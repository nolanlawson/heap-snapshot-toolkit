...
export declare const enum OperatorCode {
    ...
    array_set = 64278,
    array_len = 64279,
    array_copy = 64280,// Non-standard experiment in V8.
    array_init = 64281,
    ...
    rtt_canon = 64304,
    rtt_sub = 64305,
    rtt_fresh_sub = 64306,// Non-standard experiment in V8.
    ref_test = 64320,
...
export declare const OperatorCodeNames: (string | undefined)[];
...
export type ImportEntryType = ITableType | IMemoryType | IGlobalType | IEventType;
