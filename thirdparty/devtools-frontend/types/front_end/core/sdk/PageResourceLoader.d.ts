 ...
 */
class PageResourceLoader extends Common.ObjectWrapper.ObjectWrapper<EventTypes> {
    #private;
...
declare function getLoadThroughTargetSetting(): Common.Settings.Setting<boolean>;
