...
export declare const CATEGORY_CHECKBOX = "[title^=\"Group displayed issues under\"]";
export declare const KIND_CHECKBOX = "[title^=\"Group displayed issues as\"]";
...
export declare const SOURCES_LINK = ".affected-source-location > button";
...
export declare function getHideIssuesMenu(root?: puppeteer.ElementHandle): Promise<puppeteer.ElementHandle<import("../../../front_end/panels/issues/components/HideIssuesMenu.js").HideIssuesMenu>>;
...
export declare function waitForTableFromResourceSectionContents(resourceContentElement: puppeteer.ElementHandle<Element>, expected: Array<Array<string | RegExp>>): Promise<string[][]>;
