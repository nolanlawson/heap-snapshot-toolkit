...
export declare const getComputedStylesForDomNode: (elementSelector: string, styleAttribute: keyof CSSStyleDeclaration) => Promise<string | number | ((property: string) => string) | ((property: string, value: string | null, priority?: string) => void) | CSSRule | ((property: string) => string) | ((property: string) => string) | ((index: number) => string) | (() => ArrayIterator<string>) | null>;
